...
class PhoneInHome extends React.Component {
    ...
    componentDidMount() {
        axios.get(`http://localhost:7000/api/phones/huawei`)// địa chỉ AIP
            .then((result) => {
        ...
        return (
            <div className='PageIPhoneComponent'>
                <div className="banner">
                        <img src="https://cdn.cellphones.com.vn/media/ltsoft/promotioncategory/cate_huawei_810.png" />
                </div>
